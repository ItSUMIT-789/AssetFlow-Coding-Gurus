      ...
      <section className="relative hidden overflow-hidden bg-navy-950 p-12 text-white lg:flex lg:flex-col">
        ...
        <div className="relative my-auto max-w-lg">
          ...
          <div className="relative mt-10 h-56">
            <div className="absolute left-10 top-0 w-64 rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur">
            ...
            <div className="absolute bottom-0 right-6 w-56 rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
            ...
            <div className="absolute bottom-4 left-0 grid size-20 place-items-center rounded-2xl bg-brand-500 shadow-xl">
              <Boxes size={34} />
            </div>
          </div>
          <div className="mt-7 grid gap-4 sm:grid-cols-3">
            {[
              ...
              [BarChart3, "Real-time visibility"],
              [ShieldCheck, "Role-based dashboard"],
            ].map(([I, t]) => (
              <div
                className="flex items-center gap-2 text-xs font-semibold text-slate-300"
                key={t}
              >
                <I className="text-blue-400" size={17} />
                {t}
              </div>
            ))}
          </div>
        ...
        <p className="relative text-xs text-slate-500">
          © 2026 AssetFlow Enterprise Systems
        </p>
      </section>
